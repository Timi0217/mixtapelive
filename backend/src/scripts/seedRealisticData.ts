...
const spotifyTracks = [
  ...
  { id: '7qiZfU4dY1lWllzX7mPBI', name: 'Shape of You', artist: 'Ed Sheeran', album: '÷', art: 'https://i.scdn.co/image/ab67616d0000b273ba5db46f4b838ef6027e6f96' },
  ...
  { id: '7EX2vWN8FtD2kLLkW2pDUa', name: 'Levitating', artist: 'Dua Lipa', album: 'Future Nostalgia', art: 'https://i.scdn.co/image/ab67616d0000b273c48eeeedd3f7e4c2c5a73afc' },
  ...
  for (let i = 0; i < numBroadcasts; i++) {
    ...
    const broadcast = await prisma.broadcast.create({
      data: {
        ...
        status: 'live',
        caption: Math.random() > 0.5 ? `${track.name} vibes` : null,
